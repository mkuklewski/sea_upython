  ...
  entity agwb_ADC1173_wb is
    port (
      ...
      ADC_Val_i : in  t_ADC_Val;
      ADC_Val_i_ack : out std_logic;
  ...
  architecture gener of agwb_ADC1173_wb is
      signal int_Control_o : t_Control := stlv2t_Control(std_logic_vector(to_unsigned(8,17))); -- Hex value: 0x8
      ...
      if rising_edge(clk_sys_i) then
        if rst_n_i = '0' then
          ...
          int_regs_wb_m_i <= c_DUMMY_WB_MASTER_IN;
            int_Control_o <= stlv2t_Control(std_logic_vector(to_unsigned(8,17))); -- Hex value: 0x8
          ...
          if (int_regs_wb_m_o.cyc = '1') and (int_regs_wb_m_o.stb = '1') then
            ...
            when "10" => -- 0x2
               ...
               int_regs_wb_m_i.dat(16 downto 0) <= t_Control2stlv(int_Control_o);
               if int_regs_wb_m_o.we = '1' then
                 int_Control_o <= stlv2t_Control(int_regs_wb_m_o.dat(16 downto 0));
            ...
            when "11" => -- 0x3
               int_regs_wb_m_i.dat <= (others => '0');
               int_regs_wb_m_i.dat(7 downto 0) <= std_logic_vector(ADC_Val_i);
               if int_regs_wb_m_i.ack = '0' then
                  ADC_Val_i_ack <= '1';
               end if;
               int_regs_wb_m_i.ack <= '1';
            ...
            when "00" =>
               int_regs_wb_m_i.dat <= x"b6631a11";
               int_regs_wb_m_i.ack <= '1';
               int_regs_wb_m_i.err <= '0';
            when "01" =>
