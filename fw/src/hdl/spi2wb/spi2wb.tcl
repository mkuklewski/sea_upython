# Scoped constraints for spi2wb
set slave_clk  [get_clocks -quiet -of [get_ports spi_sck]]
...
if {$slave_clk != $master_clk} {
   ...
   set_max_delay -from $master_clk -to [get_cells shift_out*_reg*] $slave_clk_period -datapath_only
} elseif {$src_clk != "" && $dest_clk != ""} {
    common::send_msg_id "SPI2WB: TCL-1000" "WARNING" "The source and destination clocks are the same. \n     Instance: [current_instance .] \n  This will add unnecessary latency to the design. Please check the design for the following: \n 1) Manually instantiated XPM_CDC modules: Xilinx recommends that you remove these modules. \n 2) Xilinx IP that contains XPM_CDC modules: Verify the connections to the IP to determine whether you can safely ignore this message."
}
